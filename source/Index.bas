...
Sub GenerateIndex As String
	...
	head1.add(CreateMeta.attr("charset", "UTF-8"))
	head1.add(CreateMeta.attr2(CreateMap("name": "viewport", "content": "width=device-width, initial-scale=1")))
	head1.add(CreateTag("title").text("EndsMeet Server"))
	...
	CreateTag("div").up(div4).cls("modal-content").uniline
